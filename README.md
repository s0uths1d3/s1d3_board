...
一个基于 **Tauri 2 + Nuxt 4 + Vue 3 + Tailwind CSS** 的桌面效率工具，为剪贴板、待办、便签等日常高频操作提供系统托盘内快捷访问。
...
- **流式渲染**：便签/待办采用分批渲染 + `IntersectionObserver` 滚动加载
